#' Make Test Data for Insomnia-iCBT Build Function
#'
#' @param n Number of patients. Defaults to 50.
#'
#' @return A list of data frames
#' @export
#'
make_testdata_insomnia_iCBT <- function(n = 50){
  # n = 50 fifty patients by default
  set.seed(20230407)
  # Patient data table
